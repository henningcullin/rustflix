...
pub fn add_director_to_film(film_id: i32, person_id: i32) -> Result<i32, AppError> {
    insert(
        &create_connection()?,
...
pub fn remove_director_from_film(film_id: i32, person_id: i32) -> Result<usize, AppError> {
    delete(
        &create_connection()?,
